...
biasSupply=kei2400.keithley2400c("ASRL14::INSTR")
biasSupply.set_current_protection(10000E-6) # current protection in A
biasSupply.set_voltage_protection(500) # voltage protection in V
positiveHV=False # sign of the voltage
HVrange=106*1e3  # voltage scan range in mV in absolute value
