...
biasSupply.set_current_protection(100E-5) # current protection in A
biasSupply.set_voltage_protection(100) # voltage protection in V
positiveHV=False # sign of the voltage
HVrange=3*1e3  # voltage scan range in mV in absolute value

# Source meter as a current meter (Keithley 2400)
curMeter=kei2400.keithley2400c("ASRL23::INSTR")
curMeter.set_current_protection(100E-5) # current protection in A
